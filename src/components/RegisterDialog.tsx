...
export default function RegisterDialog() {
  const { registerDialogOpen, setRegisterDialogOpen, setLoginDialogOpen } = useAppStore()
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/auth/register', {
        ...
        body: JSON.stringify({ name, email, phone, instansi, password }),
      })
    ...
    <Dialog open={registerDialogOpen} onOpenChange={setRegisterDialogOpen}>
      <DialogContent className="sm:max-w-md max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Buat akun untuk mengajukan peminjaman aula dan kendaraan
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="reg-instansi">Instansi/Organisasi</Label>
            <Input
              id="reg-instansi"
              type="text"
